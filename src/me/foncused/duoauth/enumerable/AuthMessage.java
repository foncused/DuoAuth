...
public enum AuthMessage {
	...
	AUTH_IN_PROGRESS(ChatColor.GOLD + "Authentication in progress - please be patient..."),
	AUTH_IN_PROGRESS_ADMIN(ChatColor.RED + "That user is currently performing an authentication attempt. Please try again in a moment.");
